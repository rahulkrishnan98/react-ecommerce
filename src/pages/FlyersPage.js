...
import cardImage from '../assets/images/flyer.png'
            ...
            <Container fluid={true} >
                <Row className="flex" >
                    ...
                    <div class="col-md-5">
                        ...
                        &nbsp;<br />
                        &nbsp;<br />
                            <h3 style={{ display: 'inline' }} className="display-7 font-weight-light">Premium Flyers </h3>
                    ...
                    &nbsp;
                    &nbsp;
                    <p style={{ color: "grey", lineHeight: "15px" }}><strong>Premium Flyers in multiple variations</strong></p>
